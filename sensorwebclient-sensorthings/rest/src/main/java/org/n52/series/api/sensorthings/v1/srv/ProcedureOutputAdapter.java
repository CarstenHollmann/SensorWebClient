...
import org.n52.series.api.sensorthings.v1.io.ProcedureConverter;
...
public class ProcedureOutputAdapter extends AbstractOutputAdapter implements ParameterService<ProcedureOutput> {
    ...
    private Procedure[] filter(SensorThingsMetadata metadata, QueryParameters query) {
