...
import org.n52.series.api.sensorthings.v1.io.OfferingConverter;
...
public class OfferingOutputAdapter extends AbstractOutputAdapter implements ParameterService<OfferingOutput> {
    ...
    private Offering[] filter(SensorThingsMetadata metadata, QueryParameters query) {
