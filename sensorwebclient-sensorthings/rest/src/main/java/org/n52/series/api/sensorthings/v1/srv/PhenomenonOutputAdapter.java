...
import org.n52.series.api.sensorthings.v1.io.PhenomenonConverter;
...
public class PhenomenonOutputAdapter extends AbstractOutputAdapter implements ParameterService<PhenomenonOutput> {
    ...
    private Phenomenon[] filter(SensorThingsMetadata metadata, QueryParameters query) {
