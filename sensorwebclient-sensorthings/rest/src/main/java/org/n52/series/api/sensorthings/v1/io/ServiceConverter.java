 ...
 */
package org.n52.series.api.sensorthings.v1.io;
...
public class ServiceConverter extends OutputConverter<SensorThingsMetadata, ServiceOutput> {

    public ServiceConverter(SensorThingsMetadata metadata) {
        super(metadata);
    }

    @Override
    public ServiceOutput convertExpanded(SensorThingsMetadata metadata) {
    ...
    private ParameterCount countParameters(SensorThingsMetadata metadata, ServiceOutput convertedService) {
    ...
    @Override
    public ServiceOutput convertCondensed(SensorThingsMetadata toConvert) {
