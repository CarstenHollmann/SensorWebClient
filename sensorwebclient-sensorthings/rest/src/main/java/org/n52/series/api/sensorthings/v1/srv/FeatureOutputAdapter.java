...
import org.n52.series.api.sensorthings.v1.io.FeatureConverter;
...
public class FeatureOutputAdapter extends AbstractOutputAdapter implements ParameterService<FeatureOutput> {
    ...
    private Feature[] filter(SensorThingsMetadata metadata, QueryParameters query) {
