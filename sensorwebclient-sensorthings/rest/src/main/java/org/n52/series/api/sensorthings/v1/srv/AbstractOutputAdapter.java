...
public abstract class AbstractOutputAdapter {
    ...
    protected Collection<SensorThingsMetadata> getSensorThingsMetadatas() {
    	Set<SensorThingsMetadata> metadatas = new HashSet<SensorThingsMetadata>();
    	for (Metadata metadata : getMetadatas()) {
    		if (metadata instanceof SensorThingsMetadata) {
    			metadatas.add((SensorThingsMetadata)metadata);
    		}
		}
    	return metadatas;
    }
