...
public class SensorThingsSensorDecoderTest extends AbstractSensorThingsDecoderTest {
	
	
	private JsonNode node;
	
	private SensorThingsSensorDecoder decoder;
	
    @Before
    public void setUp() {
    	node = getJsonFromFile("/st_sensor.json");
    	decoder = new SensorThingsSensorDecoder(null, URL);
    }
	...
	public void test_parsing_node() throws IOException, ExceptionReport, OXFException {
		List<SensorThingsSensor> set = decoder.decode(node);
